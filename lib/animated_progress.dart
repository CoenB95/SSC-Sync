    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return CircularProgressIndicator(
          value: widget.progress == null ? null : progressTween.evaluate(animCurve),
        );
      },
    );
